...
names(data) <- c("Fakultas", "Peminat","Lulus", "Sudah", "Belum", "Sudah (%)", "Belum (%)")
kable(data) %>%
  kable_styling(bootstrap_options = "striped", full_width = F,
                latex_options = "scale_down") %>%
  add_header_above(c(" " = 3, "Registrasi" = 4))
...
names(data) <- c("Fakultas/Program Studi", "Peminat","Lulus", "Sudah", "Belum", "Sudah (%)", "Belum (%)")
